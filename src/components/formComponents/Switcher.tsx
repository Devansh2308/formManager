...
import { Divider, Grid, Slider, Switch, TextField as MaterialTextField, TextFieldProps } from "@material-ui/core"
...
import SwitchInput from "./customizedComponents/Switcher";
...
const SwitchComponent: TComponentType = {
    component: (props: any) => {
        ...
        return <SwitchInput label="Switch" />
    },
    componentSettings: [],
    type: "SWITCHER",
    itemName: "Switch",
